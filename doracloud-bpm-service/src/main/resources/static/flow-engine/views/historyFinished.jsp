...
window.onload=function (){
	...
	function getData(){
		...
		$.ajax({
			...
			data : {
				"tag" : "MethodServlet",
				"method" : "queryHistoricProcessInstancesFinished",
	...
	function diagram(target){
		...
		window.open(window.location.protocol+'/module-bpm/diagram-viewer/index.html?processDefinitionId='+processDefinitionId+'&processInstanceId='+processInstanceId+'');
		//alert('function approve');
		/*$.ajax({
			type : 'POST',
			url : window.location.protocol+"${pageContext.request.contextPath}/AbstractServlet",
