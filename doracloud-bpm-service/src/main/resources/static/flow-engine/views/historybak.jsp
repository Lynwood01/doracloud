...
<iframe id="mainIframe" name="mainIframe" src="history2.jsp" class="module-iframe" scrolling="auto" frameborder="0" style="width:100%;height:100%;"></iframe>
<script>
window.onload=function (){
	$('#btn1').click(function(){
		...
		$.ajax({
			type : 'POST',
			url : "http://localhost:8080/BPM/AbstractServlet",
			data : {
				"tag" : "MethodServlet",
	...
	$('#btn2').click(function(){
		...
		$.ajax({
			type : 'POST',
			url : "http://localhost:8080/BPM/StartProcess",
			data : {
	...
	$('#btnComplete').click(function(){
		...
		$.ajax({
			type : 'POST',
			url : "http://localhost:8080/BPM/Complete",
			data : {
				"userId" : userId,
				"taskId" : taskId
			},
	...
	function diagram(target){
		...
		window.open('http://localhost:8080/activiti-explorer/diagram-viewer/index.html?processDefinitionId='+processDefinitionId+'&processInstanceId='+processInstanceId+'');
		//alert('function approve');
		/*$.ajax({
			type : 'POST',
			url : "http://localhost:8080/BPM/AbstractServlet",
...
<button id="btn1" class="btn btn-primary">deploy</button>
<div id="startProcess">
	<div>
